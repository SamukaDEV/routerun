...
/**
 * This file is addapted from the Express.js router tests, which are licensed under the MIT License.
 * The original source code can be found at: https://github.com/expressjs/express/blob/master/test/Router.js
 */
...
describe('Router', function () {
    ...
    it('should not stack overflow with many registered routes', function (done) {
        var handler = function (req: IRequest, res: IResponse) { res.end(new Error('wrong handler')) };
        var router = new Router();
